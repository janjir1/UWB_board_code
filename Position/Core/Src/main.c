...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PB0_Pin|LED_R_Pin|LED_W_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB0_Pin SPI2_CS_Pin LED_R_Pin LED_W_Pin */
  GPIO_InitStruct.Pin = PB0_Pin|SPI2_CS_Pin|LED_R_Pin|LED_W_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;

...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOH, DWM_WAKEUP_Pin|DWM_RSTN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI1_CS_DWM_GPIO_Port, SPI1_CS_DWM_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI2_CS_GPIO_Port, SPI2_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_R_Pin|LED_W_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : DWM_RSTN_Pin */
  GPIO_InitStruct.Pin = DWM_RSTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DWM_RSTN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : DWM_EXTI_Pin */
  GPIO_InitStruct.Pin = DWM_EXTI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(DWM_EXTI_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : SPI1_CS_DWM_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_DWM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPI1_CS_DWM_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : CHRG_STDBY_Pin VBUS_sense_Pin */
  GPIO_InitStruct.Pin = CHRG_STDBY_Pin|VBUS_sense_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : CHRG_IND_Pin */
  GPIO_InitStruct.Pin = CHRG_IND_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CHRG_IND_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : SPI2_CS_Pin LED_R_Pin LED_W_Pin */
  GPIO_InitStruct.Pin = SPI2_CS_Pin|LED_R_Pin|LED_W_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
